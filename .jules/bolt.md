...
## 2024-05-30 - Duplicated Configuration Blocks
**Learning:** Duplicating repository additions and duplicate package installation commands caused severe hidden performance regressions via redundant I/O and network operations.
**Action:** Always verify that setup blocks (e.g., repository additions or apt updates) and package installations are not duplicated.
