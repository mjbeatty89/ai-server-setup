...
## 2026-03-01 - Setup script bottleneck fixes
**Learning:** Duplicate repository additions and redundant apt install calls severely bloat execution time.
**Action:** Ensure configuration blocks are executed exactly once and large batch sizes are used for bulk tools.
